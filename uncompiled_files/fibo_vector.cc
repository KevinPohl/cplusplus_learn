...
#include <iostream>
#include <iomanip>
#include <cmath> // for prototype of sqrt()
#include <string>
using namespace std;
...
string header =
    " Index Fibonacci number Fibonacci quotient Difference to golden ratio\n"
    "---------------------------------------------------------------------";
...
int main()
{
    ...
    // golden ratio
    lim = (1.0 + sqrt(5.0)) / 2.0; //1.618033989
    
    // header and first two Fibonacci numbers
    cout << header << endl; 
